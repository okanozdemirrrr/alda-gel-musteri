      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-0 z-[60] mt-2 w-[calc(100vw-24px)] sm:w-[380px] max-w-[calc(100vw-24px)] bg-white rounded-xl shadow-2xl border border-[#e8e8e8] overflow-hidden"
          >
            {/* Header */}
