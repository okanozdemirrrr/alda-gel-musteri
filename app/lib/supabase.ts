...
// Sadece development'ta uyarı ver
if (process.env.NODE_ENV === 'development' && typeof window !== 'undefined' && (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY)) {
